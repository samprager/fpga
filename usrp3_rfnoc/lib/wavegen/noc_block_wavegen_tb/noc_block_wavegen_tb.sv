...
`include "radio_core_regs.vh"
  ...
  ********************************************************/
  ...
  task automatic send_waveform_sample_hdr;
    input [7:0] addr;
    input [159:0] wfrm_hdr;
    begin
      tb_streamer.write_reg(sid_noc_block_wavegen,addr,wfrm_hdr[159:128] /*wfrm_cmd*/);
      tb_streamer.write_reg(sid_noc_block_wavegen,addr,wfrm_hdr[127:96] /*wfrm_id*/);
      tb_streamer.write_reg(sid_noc_block_wavegen,addr,wfrm_hdr[95:64] /* wfrm_ind*/);
      tb_streamer.write_reg(sid_noc_block_wavegen,addr,wfrm_hdr[63:32] /* wfrm_len*/);
      tb_streamer.write_reg(sid_noc_block_wavegen,addr,wfrm_hdr[31:0] /* wfrm_placeholder*/);
    end
  endtask
  ...
  ********************************************************/
  initial begin : tb_main
    ...
    logic [31:0] wfrm_cmd = 32'h57574441;
    logic [31:0] wfrm_id = 'b0;
    logic [31:0] wfrm_ind = 'b0;
    logic [31:0] wfrm_len = WFRM_SPP;
    logic [31:0] wfrm_placeholder= 'b0;
    ...
    ********************************************************/
    ...
    send_waveform_sample_hdr(noc_block_wavegen.SR_AWG_RELOAD,{wfrm_cmd,wfrm_id,wfrm_ind,wfrm_len,wfrm_placeholder});
