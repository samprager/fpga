...
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA0_P]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA1_N]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA1_P]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA2_N]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA2_P]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA4_N]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA4_P]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA5_N]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA5_P]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA6_N]
set_property DIFF_TERM TRUE [get_ports DB0_ADC_DA6_P]
...
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA0_P]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA1_N]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA1_P]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA2_N]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA2_P]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA4_N]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA4_P]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA5_N]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA5_P]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA6_N]
set_property DIFF_TERM TRUE [get_ports DB1_ADC_DA6_P]
# Bit 3 is in the 3.3V bank and does no support diff termination
...
set_property PULLDOWN true [get_ports {FrontPanelGpio[0]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[1]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[2]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[3]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[4]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[5]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[6]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[7]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[8]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[9]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[10]}]
set_property PULLDOWN true [get_ports {FrontPanelGpio[11]}]
